function Data = datainput_hydropower_2plant1_I
...
b=[2000;1800];%maximum amounts of water that can be released
...
b=[2000;1800]; %upper bounds on total outflow
...
function [c, ceq] =myconstr(x,n) %constraints on total outflow
    c(1,1)=n(1)*x(1)+n(5)*x(5)-2000;
    c(2,1)=n(2)*x(2)+n(3)*x(3) +n(4)*x(4)-1800;
    ceq=[];
end %myconstr