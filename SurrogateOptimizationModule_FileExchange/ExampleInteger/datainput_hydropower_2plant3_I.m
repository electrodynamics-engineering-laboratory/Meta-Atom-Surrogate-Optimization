function Data = datainput_hydropower_2plant3_I
...
b=[8000;7500];%maximum amounts of water that can be released
...
b=[8000;7500];%upper bounds on total outflow
...
function [c, ceq] =myconstr(x,n) %constraints on total outflow
    c(1,1)=n(1)*x(1)+n(5)*x(5)-8000;
    c(2,1)=n(2)*x(2)+n(3)*x(3) +n(4)*x(4)-7500;    
    ceq=[];
end %myconstr